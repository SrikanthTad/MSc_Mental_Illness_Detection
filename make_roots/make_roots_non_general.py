...
if __name__ == "__main__":
    ...
    xl.create_sheet("Stemmed_Non and General")
    copy_to(1,1,'Stemmed_Non and General') #copy headers


    while sourceRow < bottomRow:
       # text = posts.cell(sourceRow, 7).value # G column
       #  copy_to(sourceRow, removedRow, 'Cleaned_Posts') #copy them regularly first
        copy_to_v2(sourceRow, stemmedRow, 'Stemmed_Non and General')
