...
keywordsMap = {o:0 for o in commons}
# print(keywordsMap)
...
all_comments = [o.split(" ") for o in all_comments] #tokenized all sentences
# print(all_comments)

comment_features = [convert_sentence_to_features(word) for word in all_comments] #1010101010...
...
for user in userMap:
    ...
    sentences = [convert_sentence_to_features(o) for o in sentences]
    userMap[user] = sentences #make all that users words in dictionary of keywords present or no
