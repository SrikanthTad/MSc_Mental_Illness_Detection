...
if __name__ == '__main__':    # Script starts here
    ...
    root_posts = xl['Cleaned_Posts_non&general']
    sourceRow = 2 #non rooted start row
    personalRow = 2
    commonRow = 2
    nonAndGenRow = 2
    gmhRow = 2
    nmhRow = 2
    rootSourceRow = 2 #roots words start row
    ...
    while sourceRow < bottomRow:
        ...
        if (fo['long_count'] and fo['common']):
            ...
            gmhRow += 1
            print("General Mental Health - sectioned" + str(sourceRow))
        ...
        #     personalRow += 1
            ...
            nmhRow += 1
            print("Non- Mental Health - sectioned" + str(sourceRow))
